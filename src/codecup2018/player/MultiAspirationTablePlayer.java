...
public class MultiAspirationTablePlayer extends StandardPlayer {
    ...
    public MultiAspirationTablePlayer(String name, Evaluator evaluator, MoveGenerator generator, int depth) {
